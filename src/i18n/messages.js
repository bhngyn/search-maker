...
export const MESSAGES = {
  ...
  'ui.fbForm.keywordHint':       { ar: 'حقل مطلوب من Facebook. اكتب كلمة (عربية أو إنجليزية)؛ يمكن دمجها مع المرشحات أدناه.', en: 'Required by Facebook. Type a keyword (Arabic or English); combine with filters below.' },
